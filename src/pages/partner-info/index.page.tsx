  ...
  return (
    <main ref={main}>
      <RootLayout fadeOut={() => fadeOut()}>
        ...
        <CardContainer>
          <div style={{ display: "flex",width: '100%', flexDirection: isWidthGreaterThan700 ? "row" : "column" }}>
            <HeaderPartnerCardDiv>
                <HeaderPartnerCard>
            ...
            <HeadersCardDiv>
              <HeaderCards color="#5c71d6" title="Negócios em Andamento:" number="18" text="Ainda nao finalizado(s)"/>
              <HeaderCards title="Total de sua Receita:" number="R$ 17.357,19" text="Disponível para Saque"/>
            </HeadersCardDiv>
            </div>
          </CardContainer>
          <Main>
            ...
            <div style={{display:'flex', alignItems: 'center', justifyContent:"space-between"}}>
              <SwiperButton onClick={handlePrevPartnerClick} style={{marginLeft:'-0.5rem'}}>
            ...
            <SwiperComponent
              ...
              <SwiperButton onClick={handleNextPartnerClick}style={{marginLeft:'-1rem'}}>
          ...
          <Main>
            <div style={{display:'flex', justifyContent:'space-between'}}>
              ...
              <SwiperButton onClick={handlePrevIndicationClick} style={{marginRight:'0.3rem'}}>
                <img src="./swiperLeft.svg" alt=""/>
              </SwiperButton>
            ...
            <SwiperComponent
              ...
              <SwiperButton onClick={handleNextIndicationClick}style={{marginLeft:'0.3rem'}}>
                <img src="./swiperRight.svg" alt=""/>
              </SwiperButton>
              </div>
          </Main>
